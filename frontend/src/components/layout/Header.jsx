...
import { ChevronDown, Plus, Settings, User, BadgeCheck } from 'lucide-react'
import AddAccountModal from '../modals/AddAccountModal'
import './Header.css'

// Instagram text logo SVG
const InstagramLogo = () => (
  <svg aria-label="Instagram" className="header-logo-svg" fill="currentColor" height="29" role="img" viewBox="32 4 113 32" width="103">
...
// Initial test user with full info
const initialAccounts = [
  {
    ...
    bio: 'This is a test account for demo purposes',
    postsCount: 128,
    followersCount: 5420,
    followingCount: 342,
    isVerified: true,
    ...
    <>
      <header className="header">
        <div className="header-content">
          ...
          <div className="header-logo-container" ref={dropdownRef}>
            <button
              ...
              <div className="header-dropdown">
                ...
                <div className="dropdown-accounts">
                  {accounts.map((account) => (
                    <button
                      key={account.id}
                      className={`dropdown-account-item ${account.isActive ? 'active' : ''}`}
                    ...
                    >
                      ...
                      <div className="account-info">
                        ...
                        <div className="account-name">{account.profileName}</div>
                      </div>
                      {account.isActive && (
                        <div className="account-active-dot" />
                      )}
                    </button>
                  ))}
                </div>
          ...
          <button className="header-btn header-heart-btn">
